...
<body>
    ...
    <table class="table table-bordered shadow">
        ...
        <tr>
            ...
            <td>
                <a href="edit_books.php?id=<?=$book['id']?>" class="btn btn-warning">Editare</a>
                <a href="php/delete-book.php?id=<?=$book['id']?>" class="btn btn-danger">Stergere</a>
            </td>
        </tr>
        <?php } ?>
       </tbody>
    ...
    <table class="table table-bordered shadow">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="edit_categories.php?id=<?=$category['id']?>" class="btn btn-warning">Editare</a>
                    <a href="php/delete-category.php?id=<?=$category['id']?>" class="btn btn-danger">Stegere</a>
                </td>
            </tr>
            <?php } ?>
        </tbody>
    ...
    <table class="table table-bordered shadow">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?=$author['nume']?></td>
                <td>
                    <a href="edit_authors.php?id=<?=$author['id']?>" class="btn btn-warning">Editare</a>
                    <a href="php/delete-author.php?id=<?=$author['id']?>" class="btn btn-danger">Stegere</a>
                </td>
            </tr>
            <?php } ?>
        </tbody>
...
<form action="admin.php"> 
    <button type="submit" style="background-color: #2471a3; color: #2ecc71" disabled>Preview</button> 
</form> 
<a role="link" aria-disabled="true">1</a> 
<a href="second_page.php" class="nav-link">2</a> 
