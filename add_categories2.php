...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="admin2.php">Admin</a>
    ...
    <form action="php2/add-category2.php"
          method="POST"
        ...
        <?php } ?>
        <div class="mb-3">
               <label class="form-label">Denumirea categoriei</label>
               <input type="text" 
                      class="form-control"
                      name="denumire_categorie">
        </div>
        <button type="submit"
                style="background-color:#339933;" 
                class="btn btn-secondary">Adauga categorie</button>
    </form>
