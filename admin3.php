...
<body>
    ...
    <table class="table table-bordered shadow">
        ...
        <tr>
            ...
            <td>
                <a href="edit_books3.php?id=<?=$book['id']?>" class="btn btn-warning">Editare</a>
                <a href="php3/delete-book3.php?id=<?=$book['id']?>" class="btn btn-danger">Stergere</a>
            </td>
        </tr>
        <?php } ?>
       </tbody>
    ...
    <table class="table table-bordered shadow">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="edit_categories3.php?id=<?=$category['id']?>" class="btn btn-warning">Editare</a>
                    <a href="php3/delete-category3.php?id=<?=$category['id']?>" class="btn btn-danger">Stegere</a>
                </td>
            </tr>
            <?php } ?>
        </tbody>
    ...
    <table class="table table-bordered shadow">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?=$author['nume']?></td>
                <td>
                    <a href="edit_authors3.php?id=<?=$author['id']?>" class="btn btn-warning">Editare</a>
                    <a href="php3/delete-author3.php?id=<?=$author['id']?>" class="btn btn-danger">Stegere</a>
                </td>
            </tr>
            <?php } ?>
        </tbody>
...
<a role="link" aria-disabled="true">3</a> 
<form action="admin3.php"> 
    <button type="submit" style="background-color: #2471a3; color: #2ecc71" disabled>Next</button> 
</form>
